   ...
   */
   ...
   IF !lGrande
      REDEFINE XBROWSE oBrwDet DATASOURCE oQryDet;
            ...
            HEADERS "Codigo","Detalle Articulo","Cant.","Precio U","Neto","Dto./Rec.","Sub Total","IVA","Total","Tasa","Imp.";
            FOOTERS ;
            SIZES 40,243,45,64,55,55,55,64,75,55,55 ID 1000 OF oDlg1 WHEN(oQryDet:RecCount()>0)
      ELSE
      REDEFINE XBROWSE oBrwDet DATASOURCE oQryDet;
            COLUMNS "CODART","DETART","CANTIDAD","PUNIT","NETO","DESCUENTO","STOTAL","IVA","PTOTAL","CODIVA","IMPINT";
...
DEFINE DIALOG oDlgA TITLE "Alta de Clientes" FROM 05,10 TO 26,80 OF oDlgC
   ...
   @110, 70 COMBOBOX oGet[19] VAR base:lispre ITEMS aListas OF oDlgA SIZE 40,40 PIXEL WHEN("A"$cPermi)
   @125, 70 GET oGet[22] VAR base:lispreesp  OF oDlgA PICTURE "999" SIZE 25,12 RIGHT PIXEL WHEN("A"$cPermi);
