...
FUNCTION FacturaElec(oGet, nTipoFac, nPuntoVta, nTipoDoc, cLetra, aTablasIvas, oBrw, nNro, cCae, dFecVto, nTipfor,lRemito)
...
IF lRta 
   ...
   TRY
     ...
     wsfev1:AgregaFactura(nTipoFac, nTipoDoc, nNroDoc, nFacturaNro, nFacturaNro, fechacmp,;
                          nTotal, ROUND(oGet[38]:value,2), nNeto, 0, dFecDes, dFecHas, IF(nTipoFac>=2,fechacmp,""), "PES", 1)   
     IF nTip = 3 .or. nTip = 2
